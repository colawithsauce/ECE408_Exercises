...
no_opt_kernel(const double* N, const double* M, double* P, int size, const int MASK_WIDTH)
{
...
cudaError_t
no_opt(const double* N_h, const double* M_h, double* P_h, int size, const int MASK_WIDTH)
{
